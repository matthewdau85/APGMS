...
# Load defaults from .env.local if present
$envFile = ".\.env.local"
...
# SINGLE-QUOTED HERE-STRING so $func$ is preserved literally
$sql = @'
...
DECLARE
  ...
  v_hash_after    text;
BEGIN
  -- Get latest balance/hash for this (abn,tax,period)
