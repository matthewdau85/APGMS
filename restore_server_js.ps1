# restore_server_js.ps1
param([string]$ServerPath = ".\server.js")

$ts = Get-Date -Format "yyyyMMdd_HHmmss"
if (Test-Path $ServerPath) { Copy-Item $ServerPath "$ServerPath.bak.$ts" }
...
[System.IO.File]::WriteAllText($ServerPath, $js, $Utf8NoBom)
Write-Host "server.js restored ✅"
