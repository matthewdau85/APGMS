...
export async function releasePayment(
  ...
  await pool.query(
    "insert into owa_ledger(abn,tax_type,period_id,transfer_uuid,amount_cents,balance_after_cents,bank_receipt_hash,prev_hash,hash_after,performed_by,request_id) values (,,,,,,,,,,)",
    [
      abn,
      taxType,
      periodId,
  ...
  await appendAudit({
    ...
    metadata: { rail, reference, bank_receipt_hash },
    result: "success",
    requestId,
    requestIp,
  });
